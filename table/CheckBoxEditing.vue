<template>
  <div class='searchtable'>
    <el-table
      ...
      <el-table-column
        label="Select" width="80" align='center'>
        <template slot-scope="scope">
          <el-checkbox class="edit-input" size="small" true-label="checklist"  @change="getCurrentRow($event, scope.row)" ></el-checkbox>
        </template>
      </el-table-column>
      <el-table-column label='Operation' width='90px;' align='center'>
        <template slot-scope='scope'>
