<template>
  <div class='searchtable'>
    <el-table
      ...
      @selection-change="handleFeedBack"
      style="width: 100%">
  ...
  <!-- 为了防止循环第一项显示在最后一项 -->
      ...
      <el-table-column label='PO Number' align='center'>
        <el-table-column label='action' width='110px;'>
          <template slot-scope='scope'>
           <el-button size="mini" @click="handlePoLink(scope.$index, scope.row)">PO</el-button>
          </template>
        </el-table-column>
      </el-table-column>
